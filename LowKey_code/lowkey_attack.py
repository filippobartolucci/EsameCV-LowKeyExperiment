...
if __name__ == '__main__':
    ...
    for img_name in os.listdir(dir_root):
        ...
        face_path = os.path.join(dir_root, img_name[:-4] + '_face.png')
        face.save(face_path)
        imgs.append(face)
    ...
    print("Found {} images".format(len(imgs)), end='\n\n')
    ...
    while idx < len(imgs):
        ...
        tensor_img = torch.cat([to_tensor(img).unsqueeze(0), to_tensor(img).unsqueeze(0)], dim = 0)
